...
<body>
	...
	<!-- 로그인정보 -->
  	<div class="center-header">
  		<h2><a href="#" onclick="handleSidebar1click(4)">로그인 정보</a></h2>
  	</div>
    ...
    <tr>
		...
		<td><b>연락처 : <input type="tel" class="form-control m-input" name="tel" id="telInput" required pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" maxlength="13" placeholder="예) 010-1234-5678"/></b></td>
    </tr>
    <tr>
